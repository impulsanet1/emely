...
export const CeremonyAndReception: React.FC<CeremonyAndReceptionProps> = ({
  ...
  return (
    <section id="ceremony-reception-section" className="py-2.5 px-3 max-w-md mx-auto">
      ...
      <div className="space-y-2.5">
        ...
        {hasCeremony && (
          <motion.div
            ...
            className="bg-white/95 border border-rose-200/90 rounded-2xl p-3.5 shadow-md shadow-rose-100/50 flex flex-col items-center text-center"
          >
            <div className="w-9 h-9 rounded-xl bg-rose-50 border border-rose-200 flex items-center justify-center text-rose-500 mb-1.5">
            ...
            <h3 className="font-serif-elegant text-base font-bold text-slate-800 mb-1.5">
              {ceremonyTitle}
            </h3>

            <div className="w-full space-y-1 py-2 my-1 border-y border-rose-100 text-xs">
            ...
            <a
              ...
              className="mt-1.5 inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 text-[11px] font-semibold transition-all"
            >
        ...
        >
          <div className="w-9 h-9 rounded-xl bg-amber-50 border border-amber-200 flex items-center justify-center text-amber-600 mb-1.5 shadow-sm">
          ...
          <h3 className="font-serif-elegant text-lg font-bold text-slate-800 mb-1.5">
            {receptionTitle}
          </h3>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-gradient-to-r from-amber-50 to-rose-50 hover:from-amber-100 hover:to-rose-100 text-amber-900 border border-amber-200/80 text-xs font-semibold shadow-sm transition-all"
          >
